...
spark-submit  --class  com.hx.bigdata.AppCore  --master yarn  --executor-memory 4G  --num-executors 20  statisticscars-1.0-SNAPSHOT-jar-with-dependencies.jar  &>run.log
sleep 1800
done
